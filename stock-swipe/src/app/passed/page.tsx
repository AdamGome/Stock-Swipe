      ...
      <div className="bg-zinc-900 border border-zinc-700 rounded-3xl max-w-md w-full p-6 max-h-[85vh] overflow-y-auto">
        ...
        <div className="bg-zinc-800 rounded-2xl p-4 mt-5">
          ...
          <p className="text-zinc-200 leading-relaxed">
            {stock.breakdown ||
              stock.summary ||
              "This passed stock does not have a full breakdown yet. Later, we will connect AI so the app can generate a deeper company explanation automatically."}
          </p>
        </div>
  ...
  return (
    <main className="min-h-screen bg-black text-white p-6">
      <div className="max-w-md mx-auto">
        ...
        <h1 className="text-4xl font-bold mt-8">Passed Stocks</h1>

        <p className="text-zinc-400 mt-2">
          These are the stocks you swiped left on.
        </p>

        {passed.length === 0 ? (
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 mt-8">
            <p className="text-zinc-300">No passed stocks yet.</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full mt-4 bg-red-500 hover:bg-red-600 py-3 rounded-full font-bold"
                  >
                    View Full Breakdown
                  </button>
